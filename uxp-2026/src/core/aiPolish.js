...
export async function polishMarkerComments(markers, settings, requestJson, onError) {
  ...
  if (typeof requestJson !== 'function') {
    throw new Error('A UXP network request adapter is required.');
  }
